...
*/
	...
	public void LoadFacebookPicture(Action<bool, string> callback, int retryCount = 0)
	{
		...
		FB.API("/me/picture?width=128&height=128&redirect=false", HttpMethod.GET, delegate(IGraphResult result){
			...
			JSONObject pictureObj = JSONObject.Parse(result.RawResult);
