...
public class StageController : MonoBehaviour {
	...
	void Start () {
		...
		DialogDataConfirm confirm = new DialogDataConfirm ("Buy Gold?", "Buy 200 Gold?", delegate(bool yn) {
...
//
//		DialogDataAlert alertReady = new DialogDataAlert ("READY", "READY!!!", delegate() {
//
//			Debug.Log("ready!");
//
//		});
...
//
//		});
//		DialogManager.Instance.Push (alertReady);
